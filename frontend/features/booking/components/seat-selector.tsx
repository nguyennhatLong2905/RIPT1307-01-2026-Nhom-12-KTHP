...
export function SeatSelector({ seats, selectedSeats, onToggleSeat, theater, showtime }: SeatSelectorProps) {
  ...
  return (
    <div className="flex flex-col p-10 bg-[#0f0f11] min-h-screen text-white">
      ...
      <div className="flex flex-col items-center justify-center flex-1 w-full max-w-6xl mx-auto px-4">
        ...
        <div className="w-full max-w-full overflow-x-auto pb-6 flex justify-center">

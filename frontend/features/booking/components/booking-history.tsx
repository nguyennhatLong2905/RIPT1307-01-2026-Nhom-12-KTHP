                ...
                <div className="flex flex-col items-end gap-3 w-full md:w-auto border-t md:border-t-0 border-white/5 pt-4 md:pt-0">
                  ...
                  <div className="flex gap-2 relative z-20">
                    <Button 
                      variant="outline"
                      onClick={() => {
                        console.log("Navigating to details for booking:", booking.id);
                    ...
                    <Button 
                      ...
                      className="border-red-500/40 text-red-500 hover:bg-red-500/20 hover:border-red-500 rounded-xl px-5 h-11 flex items-center gap-2 text-xs font-bold transition-all cursor-pointer"
                    >
                      <Trash2 size={14} />
                      Cancel
                    </Button>

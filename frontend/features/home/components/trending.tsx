...
function MovieCard({ movie, isInitiallyLiked }: { movie: MovieType, isInitiallyLiked: boolean }) {
  ...
  useEffect(() => {
    // Nếu đã đăng nhập, kiểm tra xem phim này có trong wishlist không
    // (Trong thực tế nên tải toàn bộ wishlist 1 lần ở component cha)
  }, []);
...
export default function Trending() {
  ...
  if (isLoading) return <div className="w-full bg-black py-18 text-center text-[#c9a84c] animate-pulse">ĐANG TẢI PHIM...</div>;
